...
export function MobileDecisionsPage() {
  ...
  return (
    <div className="acMobilePage acMobileDecisionsPage" data-mobile-guide="decisions-overview">
      <p className="acMobilePageIntro acMobileDecisionsIntro">{t.mobile.decisions.intro}</p>
