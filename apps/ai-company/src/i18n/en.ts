...
export const en = {
  ...
  firstFiveMinutesGuide: {
    title: 'Start here',
    subtitle: 'Six steps in 5 minutes — one clear first-run path for Owner.',
    cta: 'Start with MAX',
    ...
    steps: {
      companyState: {
        ...
        whatItIs: 'Owner home — /ops overview with live company metrics.',
        why: 'See whether the company is ready, idle, or needs attention.',
        afterClick: 'Stays on /ops with status, completed work, and decisions.',
        expectedResult: 'Honest picture before you assign work to MAX.',
      },
      openMax: {
        title: 'Open MAX',
        whatItIs: 'MAX workspace — queue, loop, and daily work surface.',
        why: 'Meet your first digital employee before assigning a task.',
        afterClick: 'Opens /ops/employees/ag-max/workspace.',
        expectedResult: 'You see where MAX works and what is in the queue.',
      },
      assignTask: {
        title: 'Assign a task',
        whatItIs: 'Task form for MAX.',
        why: 'The main way to start delivery work.',
        afterClick: 'Opens /ops/run-task with MAX selected.',
        expectedResult: 'MAX accepts the task and starts the worker loop.',
      },
      startWorkday: {
        title: 'Start the workday',
        whatItIs: 'MAX today screen — shift, queue, day summary.',
        why: 'Start or continue MAX operating day.',
        afterClick: 'Opens /ops/employees/ag-max/today.',
        expectedResult: 'Workday status and queue are visible.',
      },
      morningReport: {
        title: 'Read the morning report',
        whatItIs: 'Morning summary for Owner.',
        why: 'See what was done and what needs a decision.',
        afterClick: 'Opens /ops/morning-report.',
        expectedResult: 'Brief with outcomes, risks, and next step.',
      },
      ownerDecisions: {
        title: 'Check Owner decisions',
        whatItIs: 'Pending approvals and Owner gates.',
        why: 'Some actions wait for your decision.',
        afterClick: 'Opens /ops/approvals.',
        expectedResult: 'All pending approve/reject items are visible.',
      },
    },
  },
  ...
  ownerHome: {
    ...
    companyStatus: {
      ...
      readyHint: 'Ready for first launch — follow “Start here” below.',
      attentionHint: 'Needs your decision or unblocks a blocked task.',
      operatingStatus: {
        ready: 'Ready for first launch',
        operating: 'Operating',
        idle: 'Idle',
    ...
    nextActions: {
      runTask: {
        ...
        description: 'Describe the first task and send it to MAX.',
      },
      morningReport: {
      ...
      maxToday: {
        label: 'MAX workday',
        description: 'Status, progress, and day summary.',
      },
      maxQueue: {
        label: 'MAX task queue',
        description: 'Queue on MAX workspace.',
      },
      approvals: {
        label: 'Review Owner decisions',
        description: 'Pending approvals and gates.',
      },
    },
    secondaryLinks: {
      aria: 'Secondary Owner actions',
      openMax: 'Open MAX',
      startWorkday: 'Start workday',
      assignTask: 'Assign task',
      maxToday: 'MAX workday',
      approvals: 'Owner decisions',
    },
    empty: {
      completedTasks: 'No completed tasks today yet. Assign a task to MAX or open the queue.',
  ...
  morningReport: {
    ...
    stats: {
      ...
      remainingQueue: 'In queue',
    },
    sections: {
      whatDone: 'What was done',
      whatDoneHint: 'Completed MAX tasks from Daily Journal — work summary and results.',
      reportsCreated: 'Reports created',
      modelsUsed: 'Models used',
      modelsUsedHint: 'Local Ollama and Decision Plan pipeline from Journal.',
      toolsUsed: 'Tools used',
      toolsUsedHint: 'Tool Registry and Cursor Automation from Journal.',
      consultations: 'Consultations',
      consultationsHint: 'Peer consult from Worker Loop / Decision Plan.',
      whatDiscovered: 'Decisions and findings',
      whatDiscoveredHint: 'Journal decisions and Worker Loop findings (fallback).',
      memoryDrafts: 'Memory Drafts',
      knowledgeCandidates: 'Knowledge Candidates',
      needsOwner: 'What needs Owner decision',
      needsOwnerHint: 'Owner Approval from Journal + Cursor gates and Work Scheduler.',
      remainingQueue: 'Remaining in queue',
    ...
    empty: {
      ...
      modelsUsed: 'No models recorded in Journal.',
      toolsUsed: 'No tools used.',
      consultations: 'No peer consultations.',
      whatDiscovered: 'No decisions or findings recorded — run Worker Loop.',
  ...
  maxWorkspace: {
    ...
    workQueue: {
      ...
      empty: 'MAX has no tasks in the queue yet.',
      suggestedAction: 'Next suggested action',
      activeLabel: 'Active item',
      pendingLabel: 'Pending tasks',
      running: 'Running a queued task — Worker Loop is active…',
      footnote: 'Queue is stored locally (Employee Work Queue V1). For one-off tasks use',
      stats: {
      ...
      actions: {
        addTest: 'Add test task',
        startNext: 'Run next task',
        runAll: 'Run entire queue',
      },
      feedback: {
        testAdded: 'Test task added to MAX queue.',
        started: 'Started task: “{title}”.',
        runAllDone: 'Processed tasks: {count}.',
        runAllPartial: 'Processed before error: {count}.',
      },
      errors: {
        generic: 'Failed to run queued task.',
        emptyQueue: 'Queue is empty — add a task.',
      },
    },
  },
  workScheduler: {
  ...
  employeeOperatingDay: {
    title: 'Today',
    pageTitle: '{name} — Today',
    pageDescription:
      'Employee operating day — workday status, task progress, hours, consultations, decisions, reports, and day summary.',
    heroDescription: 'Operating day workspace for {name}. Not MAX Workspace.',
    notFoundDescription: 'Employee not found or operating day cannot be loaded.',
    openProfile: 'Employee profile',
    openCurrentTask: 'Open task',
    currentTaskTitle: 'Current task',
    daySummaryTitle: 'Day summary',
    noCurrentTask: 'No active task in the queue.',
    noDaySummary: 'Day summary will appear after tasks or when the workday is finished.',
    startedAt: 'Started',
    finishedAt: 'Finished',
    yes: 'Yes',
    no: 'No',
    hoursShort: 'h',
    minutesShort: 'min',
    localNote: 'Aggregated from Workday, Daily Journal, and Work Queue — localStorage only.',
    status: {
    ...
    operatingDaySummary: {
      ...
      empty: 'The operating day summary will appear after the day is finished.',
      ...
      consultations: 'Consultations',
      reportsCreated: 'Reports created',
      nextDayRecommendations: 'Next-day recommendations',
      noItems: '—',
      usageCount: '{count}×',
    },
  },
