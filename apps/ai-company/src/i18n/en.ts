...
export const en = {
  ...
  maxWorkerLoop: {
    ...
    startNote: 'MAX Worker Loop V1 — reasoning, report, and Memory/Knowledge drafts.',
    phaseStatus: {
      pending: 'Pending',
      active: 'Running',
      done: 'Done',
  ...
  maxWorkspace: {
    pageTitle: 'MAX — workspace',
    pageDescription:
      'MAX digital employee desk: current task, Worker Loop, Cursor Automation, Memory/Knowledge drafts and next steps — real data only.',
    principleNote:
      'No fake progress: statuses and phases reflect actual MAX Worker Loop and Runtime. Empty sections mean no data yet.',
    runningNote: 'Cycle is running — phases update as Task Runner / Ollama makes real progress.',
    sections: {
      workStatus: 'Work status',
      thinkingModel: 'Reasoning model',
      workerLoopPhase: 'Worker Loop phase',
    ...
    empty: {
      noLoopHint:
        'MAX has not started a Worker Loop yet. Run a task via Run Task — real work status will appear here.',
      noTask: 'No task assigned',
      noModel: 'Model will be known after reasoning starts',
      externalExecutor: 'External executor not required or cycle has not finished analysis.',
      ownerApproval: 'Owner Approval gate appears after Cursor Automation handoff.',
      cursorAutomation: 'Cursor Automation is not active for the current cycle.',
      lastReport: 'No reports for the current cycle yet.',
      memoryDrafts: 'Memory Evolution drafts appear after a completed Worker Loop.',
      knowledgeCandidates: 'Knowledge Candidates appear after a completed Worker Loop.',
      nextActions: 'Next Actions appear after Runtime Report.',
    },
