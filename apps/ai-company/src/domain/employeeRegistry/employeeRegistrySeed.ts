...
export const EMPLOYEE_REGISTRY_SEED: EmployeeProfile[] = [
  ...
  },
  {
    ...
    capabilities: [
      capability('implementation', 'Feature implementation', false),
      capability('refactoring', 'Refactoring', false),
      capability('code_review', 'Code review support', false),
      capability('work_queue', 'Work Queue tasks', false),
    ],
    currentWorkload: 0,
